          ...
          div(class = "panel panel-default",
              ...
              div(class = "panel-body",
                  ...
                  img(src = "img/cp2_abspovch_large.png", 
                        alt = "Line chart of the absolute child poverty rate over time, showing an initial fall followed by stagnation in recent years, with a level considerably higher than the targets."))),
          div(class = "panel panel-default",
