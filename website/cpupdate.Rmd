---
title: "Infographic child poverty update"
          ...
          div(class = "panel panel-default",
              ...
              div(class = "panel-body",
                  ...
                  img(src = "img/cp1_relpovch_large.png", 
                        alt = " Line chart of the relative child poverty rate over time, showing a small increase in recent years that may now have stopped at a level remaining considerably above the targets. "))),
          div(class = "panel panel-default",
              ...
              div(class = "panel-body",
                  ...
                  img(src = "img/cp3_matdepch_large.png",
                      alt = " Line chart of the proportion of children in combined low income and material deprivation over time, showing little change and a level that is considerably higher than the targets. ")))),
          ...
          div(class = "panel panel-default",
              ...
              div(class = "panel-body",
                  ...
                  img(src = "img/cp2_abspovch_large.png", 
                        alt = " Line chart of the absolute child poverty rate over time, showing an initial fall followed by stagnation in recent years at a level considerably higher than the targets. "))),
          div(class = "panel panel-default",
              ...
              div(class = "panel-body",
                  ...
                  img(src = "img/cp4_perspov_large.png",
                      alt = " Line chart of the persistent child poverty rate over time, showing no clear trend and a level that is considerably higher than the targets. "))))
 )
