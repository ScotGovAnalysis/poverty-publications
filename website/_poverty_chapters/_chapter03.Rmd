...
add_caption("Figure 1 - Proportion of people in relative poverty, Scotland")
...
```{r chart02}
add_caption("Figure 2 - Proportion of people in absolute poverty, Scotland")
...
```{r chart04}
add_caption("Figure 4 - Proportion of working-age adults in relative poverty, Scotland")
...
```{r chart05}
add_caption("Figure 5 - Proportion of working-age adults in absolute poverty, Scotland")
...
```{r chart06}
add_caption("Figure 6 - Proportion of working-age adults in relative poverty who live in a working household, Scotland")
...
```{r chart07}
add_caption("Figure 7 - Proportion of pensioners in relative poverty, Scotland")
...
```{r chart08}
add_caption("Figure 8 - Proportion of pensioners in absolute poverty, Scotland")
...
```{r chart09}
add_caption("Figure 9 - Proportion of pensioners in material deprivation")
