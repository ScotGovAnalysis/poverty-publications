...
```{r}
keymessage <- "People in poverty often lack food security"
message(keymessage)
```

add stats here, i.e. xx% of people lived in households with high food security etc.
...
subtitle <- str_c("Levels of food security of all people and those in poverty after housing costs, Scotland ", params$data_year, " (fake data!)")
...
```{r}
keymessage <- "Share of working-age adults in poverty who live in working households now stable"
message(keymessage)
```
