...
#### Figure 14 - Levels of food security of all children and those in poverty, Scotland `r params$data_year` (fake data!)
```{r chart14}
...
#### Figure 16 - Proportion of children in absolute poverty after housing costs, Scotland
```{r chart16}
...
#### Figure 17 - Proportion of children in combined low income and material deprivation, Scotland
```{r chart17}
