...
```{r}
keymessage <- "In-work poverty for children no longer rising"
message(keymessage)
```
...
```{r}
keymessage <- "Add key message here"
message(keymessage)
```
...
subtitle <- str_c("Levels of food security of all children and those in poverty, Scotland ",
...
```{r chart15}
keymessage <- "Add a key message here"
