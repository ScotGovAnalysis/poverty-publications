...
```{r chart10}
add_caption("Figure 10 - Proportion of children in relative poverty, Scotland")
...
```{r chart11}
add_caption("Figure 11 - Proportion of children in absolute poverty, Scotland")
...
```{r chart12}
add_caption("Figure 12 - Proportion of children in combined low income and material deprivation, Scotland")
...
```{r chart13}
add_caption("Figure 13 - Proportion of children in relative poverty who live in working households, Scotland")
...
```{r chart15}
add_caption("Figure 15 - Proportion of children in relative poverty after housing cost, Scotland")
...
```{r chart16}
add_caption("Figure 16 - Proportion of children in absolute poverty after housing costs, Scotland")
...
```{r chart17}
add_caption("Figure 17 - Proportion of children in combined low income and material deprivation, Scotland")
interactive(povertycharts[["chart17"]])
```
