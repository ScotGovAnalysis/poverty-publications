...
In `r params$data_period`, the top ten percent of the population had 24% more income (before housing costs) than the bottom forty percent combined. This compares to 33% more income of the top ten percent in 2007-10, the period with the highest income inequality in this time series as measured by the Palma ratio.
...
```{r chart26}
caption <- "Figure 26: Palma ratio of income inequality, Scotland"
interactive(povertycharts[["chart26"]], caption = caption)
```
...
```{r chart27}
caption <- "Figure 27: Gini coefficient of income inequality, Scotland"
interactive(povertycharts[["chart27"]], caption = caption)
```
