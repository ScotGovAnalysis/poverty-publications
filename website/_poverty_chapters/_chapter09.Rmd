...
Income after housing costs (AHC) is derived by deducting a [measure of housing costs](#housing-costs) from the above income measure.
...
Following a subsequent review the National Statistician, John Pullinger, wrote to the Chair of the `r abbr("UK", "United Kingdom")` Statistics Authority, Sir Andrew Dilnot, setting out his view that RPI "is not a good measure of inflation" and that future usage is strongly discouraged in favour of alternative measures.

This led to a change in `r abbr("HBAI", "Households Below Average Income")` methodology in 2014/15 and the Scottish Government adopted the change in deflator to allow consistent poverty estimates for Scotland and the `r abbr("UK", "United Kingdom")`.
...
For a couple with no children, the `r abbr("UK", "United Kingdom")` median income before housing vosts in `r params$data_period` was £517 per week, which had increased by £6 in real terms since 2015-18. After housing costs, the `r abbr("UK", "United Kingdom")` median increased by £5 to £464 per week compared to 2015-18.
...
In the 2010/11 `r abbr("FRS", "Family Resources Survey")`, both the new and the old questions were asked. As such, estimates are presented based on both sets of questions for this year.
...
* Legard, R., Gray, M. and Blake, M. (2008), Cognitive testing: older people and the `r abbr("FRS", "Family Resources Survey")` material deprivation questions, Department for Work and Pensions Working Paper Number 55. [Available on the Bristol University webpages (pdf)](https://www.bristol.ac.uk/poverty/downloads/keyofficialdocuments/FRS%20cognitive%20testing%20of%20older%20people%20dep%20questions.pdf).
* McKay, S. (2008), Measuring material deprivation among older people: Methodological study to revise the Family Resources Survey questions, Department for Work and Pensions Working Paper Number 54. [Available on the Bristol University webpages (pdf)](https://www.bristol.ac.uk/poverty/downloads/keyofficialdocuments/FRS%20Older%20people%20deprivation%20questions%20report.pdf).
...
The Family Resources Survey collected food security information for the first time in 2019/20. The questions were adopted from the [United States Department of Agriculture's Adult Food Security Survey Module (pdf)](https://www.ers.usda.gov/media/8279/ad2012.pdf), using a 30-day reference period, and using the same food security levels ("high", "marginal", "low", "very low"). Previously, data on food insecurity in Scotland was collected by the Scottish Health Survey.
