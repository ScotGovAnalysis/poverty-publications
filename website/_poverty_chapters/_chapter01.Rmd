              ...
              div(class = "panel-body",
                  a(href = "#relpov",
                    img(src = "img/chart0a.png", 
                        alt = "Line chart of the relative poverty rate over time, showing that the very slow poverty increase in recent years may have ended.")),
              ...
              div(class = "panel-body",
                  a(href = "#palma",
                    img(src = "img/chart0b.png", 
                        alt = "Line chart of the Palma ratio over time, showing that income inequality continues to fluctuate.")),
             ...
             div(class = "panel-body",
                 a(href = "#incometrends",
                   img(src = "img/chart0c.png", 
                        alt = "Line chart of median household incomes over time, showing a steady increase.")),
