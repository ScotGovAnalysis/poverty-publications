...
#### Figure 18 - Proportion of adults in relative poverty after housing costs, Scotland
```{r chart18}
...
`r infobox("In this publication, 'child' refers to a dependent child living in the household. This is explained in the [Definitions section](index.html#child). <br>Estimates for single fathers are not available due to small sample sizes.")`

#### Figure 19 - Proportion of single working-age adults in relative poverty after housing costs, Scotland
```{r chart19}
...
#### Figure 20 - Proportion of single pensioners in relative poverty after housing costs, Scotland
```{r chart20}
...
#### Figure 21 - Proportion of adults in relative poverty after housing costs, Scotland
```{r chart21}
...
#### Figure 22 - Proportion of people in relative poverty after housing costs, Scotland 2014-2019
```{r chart22}
...
#### Figure 23 - Proportion of adults in relative poverty after housing costs, Scotland 2014-19
```{r chart23}
...
#### Figure 24 - Proportion of people in relative poverty after housing costs, Scotland
```{r chart24}
...
#### Figure 25 - Proportion of people in relative poverty (disability benefits removed from household income) after housing costs, Scotland
```{r chart25}
