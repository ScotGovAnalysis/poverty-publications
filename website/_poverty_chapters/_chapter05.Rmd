...
```{r}
keymessage <- "Relative poverty rates higher for the youngest adults"
message(keymessage)
```
...
```{r}
keymessage <- "Relative poverty rates highest for single women with children but gap is smaller than it used to be"
message(keymessage)
```
...
interactive(povertycharts[["chart19"]], height = 5, title = title,
            subtitle = subtitle)
```
...
interactive(povertycharts[["chart20"]], height = 5, title = title,
            subtitle = subtitle)
```
...
subtitle <- "Proportion of adults in relative poverty after housing costs, Scotland"
interactive(povertycharts[["chart21"]], height = 5, title = title,
            subtitle = subtitle)
```
...
interactive(povertycharts[["chart22"]], title = title,
            subtitle = subtitle)
```
...
subtitle <- str_c("Proportion of adults in relative poverty after housing costs, Scotland ", 
                  params$data_period_5)
interactive(povertycharts[["chart23"]], title = title, subtitle = subtitle)
```
...
interactive(povertycharts[["chart24"]], height = 3.5,  title = title,
            subtitle = subtitle)
```
...
```{r}
keymessage <- "Relative poverty rates, with disability benefits removed from household income, higher where a household member is disabled"
message(keymessage)
```
...
interactive(povertycharts[["chart25"]], height = 4,  title = title,
            subtitle = subtitle)
```
