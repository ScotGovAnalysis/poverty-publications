...
`r infobox("Note that poverty is a household measure. Everyone in the same household is considered either in poverty or not in poverty. Therefore, the poverty status of an adult depends on the whole household.")`
