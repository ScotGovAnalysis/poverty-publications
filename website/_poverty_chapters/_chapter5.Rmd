...
Income after housing costs (AHC) is derived by deducting a [measure of housing costs](#housing-costs-definition) from the above income measure.

### Housing costs {#housing-costs-definition}
...
### Equivalisation {#equivalisation-definition}
...
incA <- filter(htmltables$inc_3, Measure == "After housing costs")[[params$data_period]]
incB <- filter(htmltables$inc_3, Measure == "Before housing costs")[[params$data_period]]
incA_1 <- filter(povertytables$medians$ahc, Group == "All people")[[length(povertytables$medians$bhc) - 1]]
incB_1 <- filter(povertytables$medians$bhc, Group == "All people")[[length(povertytables$medians$bhc) - 1]]
...
### Child material deprivation {#child-material-deprivation-definition}
...
### Pensioner material deprivation {#pensioner-material-deprivation-definition}
...
The food security analysis in this report excludes [shared households](#shared-households-definition), such as a house shared by a group of professionals. These respondents may not have insight into the food security status of others in their household and may not regularly share financial information.
...
### Dependent children {#dependent-children-definition}
...
### Shared households {#shared-households-definition}
...
This analytical report contains poverty, child poverty and household income time series. [Associated tables](download.html) are available for download and contain:
...
- [Latest report](../2022/persistent.html)
