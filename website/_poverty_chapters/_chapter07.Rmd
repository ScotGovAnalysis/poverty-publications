...
caption <- str_c("Table 1: Income and poverty thresholds for different household types before housing costs, Scotland ",
                 params$data_period)
add_tablecaption(caption)
kable(povertytables[["table1"]], col.names = c("Before housing costs incomes",
                              "weekly", "annual",
                              "weekly", "annual",
                              "weekly", "annual",
                              "weekly", "annual"),
