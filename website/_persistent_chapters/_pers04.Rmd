...
Poverty estimates presented in the [Poverty and Income Inequality in Scotland report](https://data.gov.scot/poverty) come from a different source – `r abbr("DWP", "Department for Work and Pensions")`’s Households Below Average Income dataset which is produced from the Family Resources Survey (FRS). This is the best source of household income data available in the `r abbr("UK", "United Kingdom")`. However, it does not track individuals or households over time and so cannot be used to calculate persistent poverty rates.
