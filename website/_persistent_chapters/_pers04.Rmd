...
##### Table 2: Proportion of people in persistent poverty by country {#table2}
```{r table2}
...
##### Table 3: Proportion of children in persistent poverty by country {#table3}
```{r table3}
...
##### Table 4: Proportion of working-age adults in persistent poverty by country {#table4}
```{r table4}
...
##### Table 5: Proportion of pensioners in persistent poverty by country {#table5}
```{r table5}
