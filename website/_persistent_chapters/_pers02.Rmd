...
`r infobox("The statistics presented below are subject to a degree of uncertainty. This means that implied changes over the years and between countries may not be statistically significant and instead be within a given error range. More information can be found in the [Methodology](#methodology) section.")`
