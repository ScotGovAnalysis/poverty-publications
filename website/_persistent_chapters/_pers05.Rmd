...
```{r table}
df <- data.frame(Wave = c(1:9),
                 "Start year" = c(2009:2017),
                 "End year" = c(2010:2018),
                 "In 2010-2014 statistics?" = c("no", "yes", "yes", "yes", "yes", "no", "no", "no", "no"),
                 "In 2011-2015 statistics?" = c("no", "no", "yes", "yes", "yes", "yes", "no", "no", "no"),
                 "In 2012-2016 statistics?" = c("no", "no", "no", "yes", "yes", "yes", "yes", "no", "no"),
                 "In 2013-2017 statistics?" = c("no", "no", "no", "no", "yes", "yes", "yes", "yes", "no"),
                 "In 2014-2018 statistics?" = c("no", "no", "no", "no", "no", "yes", "yes", "yes", "yes"))
