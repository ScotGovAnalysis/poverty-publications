...
```{r chart02}
interactive(povertycharts[["chart02"]])
```

### Food poverty

#### Figure 3 - Proportion of children in food poverty, Scotland
...
```{r chart05}
interactive(povertycharts[["chart05"]])
```
...
```{r chart08}
interactive(povertycharts[["chart08"]])
```
