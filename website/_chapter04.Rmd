...
```{r chart11}
interactive(povertycharts[["chart11"]])
```
...
#### Figure 14 - Proportion of children in food poverty, Scotland
...
add bar chart showing relative child poverty rates for the priority groups

#### Figure 15 - Proportion of children in food poverty, Scotland
