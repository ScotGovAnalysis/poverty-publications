...
# to do: add mother under 25 in hhld
# to do: add child age
...
data <- list(sheetname = "Child age",
             ...
             df5 = rel_numbers,
             df6 = sev_numbers,
             filename = "Child poverty characteristics.xlsx",
...
# put all input for the spreadsheet into a list
data <- list(sheetname = "Ethnicity 5-year average",
...
# put all input for the spreadsheet into a list
data <- list(sheetname = "Ethnicity 3-year average",
